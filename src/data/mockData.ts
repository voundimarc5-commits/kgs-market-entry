...
export const countries: CountryData[] = [
  { code: "NG", name: "Nigeria", name_fr: "Nigeria", overview: "Africa's largest economy with a thriving fintech ecosystem.", overview_fr: "La plus grande économie d'Afrique avec un écosystème fintech florissant.", keySectors: ["Technology", "Oil & Gas", "Agriculture"], keySectors_fr: ["Technologie", "Pétrole & Gaz", "Agriculture"], opportunities: 3, events: 1 },
  { code: "KE", name: "Kenya", name_fr: "Kenya", overview: "East Africa's innovation hub with strong mobile and fintech sectors.", overview_fr: "Le hub d'innovation d'Afrique de l'Est avec de solides secteurs mobile et fintech.", keySectors: ["Technology", "Energy", "Agriculture"], keySectors_fr: ["Technologie", "Énergie", "Agriculture"], opportunities: 2, events: 1 },
  { code: "ZA", name: "South Africa", name_fr: "Afrique du Sud", overview: "Continent's most industrialized economy with deep capital markets.", overview_fr: "L'économie la plus industrialisée du continent avec des marchés financiers profonds.", keySectors: ["Mining", "Finance", "Technology"], keySectors_fr: ["Mines", "Finance", "Technologie"], opportunities: 1, events: 2 },
  { code: "GA", name: "Gabon", name_fr: "Gabon", overview: "Resource-rich Central African nation focused on diversification.", overview_fr: "Nation d'Afrique centrale riche en ressources axée sur la diversification.", keySectors: ["Oil & Gas", "Mining", "Infrastructure"], keySectors_fr: ["Pétrole & Gaz", "Mines", "Infrastructure"], opportunities: 1, events: 0 },
  { code: "MA", name: "Morocco", name_fr: "Maroc", overview: "North Africa's gateway with strong automotive and renewable energy sectors.", overview_fr: "La porte d'entrée de l'Afrique du Nord avec de solides secteurs automobile et énergies renouvelables.", keySectors: ["Energy", "Manufacturing", "Real Estate"], keySectors_fr: ["Énergie", "Industrie", "Immobilier"], opportunities: 2, events: 1 },
  { code: "RW", name: "Rwanda", name_fr: "Rwanda", overview: "Africa's most business-friendly nation with ambitious tech vision.", overview_fr: "Le pays le plus propice aux affaires en Afrique avec une vision tech ambitieuse.", keySectors: ["Technology", "Tourism", "Real Estate"], keySectors_fr: ["Technologie", "Tourisme", "Immobilier"], opportunities: 1, events: 1 },
  { code: "CI", name: "Côte d'Ivoire", name_fr: "Côte d'Ivoire", overview: "West Africa's francophone economic hub with strong agricultural sector.", overview_fr: "Le hub économique francophone d'Afrique de l'Ouest avec un solide secteur agricole.", keySectors: ["Agriculture", "Finance", "Infrastructure"], keySectors_fr: ["Agriculture", "Finance", "Infrastructure"], opportunities: 1, events: 1 },
  { code: "SN", name: "Senegal", name_fr: "Sénégal", overview: "Emerging West African economy with oil & gas discoveries.", overview_fr: "Économie émergente d'Afrique de l'Ouest avec des découvertes de pétrole et gaz.", keySectors: ["Energy", "Technology", "Agriculture"], keySectors_fr: ["Énergie", "Technologie", "Agriculture"], opportunities: 1, events: 1 },
  { code: "GH", name: "Ghana", name_fr: "Ghana", overview: "Stable democracy with growing tech scene and natural resources.", overview_fr: "Démocratie stable avec une scène tech en croissance et des ressources naturelles.", keySectors: ["Mining", "Technology", "Infrastructure"], keySectors_fr: ["Mines", "Technologie", "Infrastructure"], opportunities: 2, events: 1 },
  { code: "ET", name: "Ethiopia", name_fr: "Éthiopie", overview: "Africa's fastest-growing economy with massive infrastructure development.", overview_fr: "L'économie à la croissance la plus rapide d'Afrique avec un développement massif d'infrastructures.", keySectors: ["Manufacturing", "Agriculture", "Infrastructure"], keySectors_fr: ["Industrie", "Agriculture", "Infrastructure"], opportunities: 0, events: 0 },
  { code: "EG", name: "Egypt", name_fr: "Égypte", overview: "North Africa's largest economy with growing AI and tech sector.", overview_fr: "La plus grande économie d'Afrique du Nord avec un secteur IA et tech en croissance.", keySectors: ["Technology", "Tourism", "Manufacturing"], keySectors_fr: ["Technologie", "Tourisme", "Industrie"], opportunities: 1, events: 1 },
  { code: "CM", name: "Cameroon", name_fr: "Cameroun", overview: "Central Africa's largest economy and key trade corridor for landlocked nations.", overview_fr: "La plus grande économie d'Afrique centrale et corridor commercial clé pour les nations enclavées.", keySectors: ["Infrastructure", "Energy", "Agriculture"], keySectors_fr: ["Infrastructure", "Énergie", "Agriculture"], opportunities: 1, events: 1 },
];
