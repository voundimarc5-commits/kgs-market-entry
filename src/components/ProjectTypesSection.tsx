...
const ProjectTypesSection = () => {
  ...
  const types = [
    { icon: Home, titleKey: "projecttypes.type1.title", descKey: "projecttypes.type1.desc" },
    { icon: Store, titleKey: "projecttypes.type2.title", descKey: "projecttypes.type2.desc" },
    { icon: Monitor, titleKey: "projecttypes.type3.title", descKey: "projecttypes.type3.desc" },
  ];
